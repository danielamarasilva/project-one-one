...
$address = "danielamaradms@gmail.com";//>>>>>>>>>>>>>>>>>>>>>Mudar aqui
$e_subject = 'Fale conosco - Autonove Multimarcas';

$e_body = "A Autonove recebeu um contato $fname $lname, their additional message is as follows." . PHP_EOL . PHP_EOL;
...
if(mail($address, $e_subject, $msg, $headers, $email)) {
	...
	echo "<h3>Não foi possível enviar o email!</h3><br>";
